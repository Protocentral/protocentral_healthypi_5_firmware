...
#define PIN_RP2040_TX_ESP32_RX 20
#define PIN_RP2040_RX_ESP32_TX 21

#define PIN_RP2040_SCK         6
#define PIN_RP2040_MISO        2
#define PIN_RP2040_MOSI        7
...
void setup()
{
  ...
  pinMode(PIN_RP2040_SCK,INPUT);
  pinMode(PIN_RP2040_MISO, INPUT);
  pinMode(PIN_RP2040_MOSI, INPUT);
...
void loop()
{
  ...
  if (currentTime - prevCountTime >= 2000)
  {
     handle_ble_stack();
